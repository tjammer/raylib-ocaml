...
module CharInfo = struct
  ...
  let value charinfo =
    getf charinfo Types.CharInfo.value

  let offset_x charinfo =
    getf charinfo Types.CharInfo.offset_x

  let offset_y charinfo =
    getf charinfo Types.CharInfo.offset_y

  let advance_x charinfo =
    getf charinfo Types.CharInfo.advance_x

  let image charinfo =
    getf charinfo Types.CharInfo.image

  let set_value charinfo value =
    setf charinfo Types.CharInfo.value value
...
module Font = struct
  ...
  let chars_padding font =
    getf font Types.Font.chars_padding
  ...
  let set_chars font chars =
    setf font Types.Font.chars (CArray.start chars)
end
...
module RayHitInfo = struct
  ...
  let distance rayhitinfo =
    getf rayhitinfo Types.RayHitInfo.distance

  let position rayhitinfo =
    getf rayhitinfo Types.RayHitInfo.position
...
module Sound = struct
  ...
  let stream sound =
    getf sound Types.Sound.stream

  let set_stream sound stream =
    setf sound Types.Sound.stream stream
end
