module Description (F : Ctypes.FOREIGN) = struct
  ...
  let swap_screen_buffer =
    foreign "SwapScreenBuffer" (void @-> returning void)

  let poll_input_events =
    foreign "PollInputEvents" (void @-> returning void)

  let wait_time =
    foreign "WaitTime" (float @-> returning void)
  ...
  let set_random_seed =
    foreign "SetRandomSeed" (uint @-> returning void)
  ...
  let get_char_pressed = foreign "GetCharPressed" (void @-> returning char)
  ...
  let get_mouse_delta =
    foreign "GetMouseDelta" (void @-> returning Vector2.t)
  ...
  let get_touch_point_id =
    foreign "GetTouchPointId" (int @-> returning int)
  ...
  let draw_line_bezier_cubic =
    foreign "DrawLineBezierCubic" (Vector2.t @-> Vector2.t @-> Vector2.t @-> Vector2.t @-> float @-> Color.t @-> returning void)
  ...
  let draw_rectangle_lines_ex =
    foreign "DrawRectangleLinesEx" (Rectangle.t @-> float @-> Color.t @-> returning void)
  ...
  let draw_rectangle_rounded_lines =
    foreign "DrawRectangleRoundedLines" (Rectangle.t @-> float @-> int @-> float @-> Color.t @-> returning void)
  ...
  let draw_poly_lines_ex =
    foreign "DrawPolyLinesEx" (Vector2.t @-> int @-> float @-> float @-> float @-> Color.t @-> returning void)
  ...
  let check_collision_point_line =
    foreign "CheckCollisionPointLine" (Vector2.t @-> Vector2.t @-> Vector2.t @-> int @-> returning bool)
  ...
  let load_image_from_memory =
    foreign "LoadImageFromMemory" (string @-> string @-> int @-> returning Image.t)
  ...
  let draw_text_pro =
    foreign "DrawTextPro" (Font.t @-> string @-> Vector2.t @-> Vector2.t @-> float @-> float @-> float @-> Color.t @-> returning void)
  ...
  let text_copy =
    foreign "TextCopy" (string @-> string @-> returning int)
  ...
  let draw_cube_texture_rec =
    foreign "DrawCubeTextureRec" (Texture.t @-> Rectangle.t @-> Vector3.t @-> float @-> float @-> float @-> Color.t @-> returning void)
  ...
  let draw_cylinder_ex =
    foreign "DrawCylinderEx" (Vector3.t @-> Vector3.t @-> float @-> float @-> int @-> Color.t @-> returning void)
  ...
  let draw_cylinder_wires_ex =
    foreign "DrawCylinderWiresEx" (Vector3.t @-> Vector3.t @-> float @-> float @-> int @-> Color.t @-> returning void)
  ...
  let draw_billboard_rec =
    foreign "DrawBillboardRec" (Camera3D.t @-> Texture.t @-> Rectangle.t @-> Vector3.t @-> Vector2.t @-> Color.t @-> returning void)

  let draw_billboard_pro =
    foreign "DrawBillboardPro" (Camera3D.t @-> Texture.t @-> Rectangle.t @-> Vector3.t @-> Vector3.t @-> Vector2.t @-> Vector2.t @-> float @-> Color.t @-> returning void)
